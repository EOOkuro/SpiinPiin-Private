...
public class ListCommentTestx {
	...
	@Test
	public void listComments(TestContext context){
		final Async async = context.async();
				
		JsonObject feed = new JsonObject();
		feed.put(QueryFilter.id, this.articleId);
		...
		client.get(this.port, "localhost", "/feeds/api/comments")
